...
{
    public class EntityProjectionExpressionVisitor : DefaultQueryExpressionVisitor
    {
        public EntityProjectionExpressionVisitor([NotNull] EntityQueryModelVisitor entityQueryModelVisitor)
